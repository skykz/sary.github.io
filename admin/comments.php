                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <form action="" method="post">
                                ...
                                <input type="submit" name="reply" class="btn btn-block btn-primary">
                            </form>
                        </div>
                    </div>
                    <hr>
                           ...
                           <?php
                            ...
                            <tr>
                               <td><input type="checkbox" class="checkboxes" name="checkboxes[]" value="<?php echo $id;?>"></td>
                                ...
                                <td><a class="btn btn-primary" href="comments.php?approve=<?php echo $id;?>">Approve</a></td>
                                <td><a class="btn btn-warning" href="comments.php?unapprove=<?php echo $id;?>">Un-approve</a></td>
                                <td><a href="comments.php?reply=<?php echo $post_id;?>"><i class="btn btn-primary fa fa-reply"></i></a></td>
                                <td><a href="comments.php?del=<?php echo $id;?>"><a  class="btn btn-warning fa fa-trash"></a></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
