                           ...
                           <?php
                            ...
                            <tr>
                               <td><input type="checkbox" class="checkboxes" name="checkboxes[]" value="<?php echo $id;?>"></td>
                                ...
                                <td><a href="edit-user.php?edit=<?php echo $id;?>"><i class="btn btn-primary fa fa-pencil"></i></a></td>
                                <td><a href="users.php?del=<?php echo $id;?>"><i class="btn btn-warning fa fa-trash"></i></a></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
