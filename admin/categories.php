                                ...
                                <tbody>
                                   <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="categories.php?edit=<?php echo $category_id;?>"><i class="btn btn-primary fa fa-pencil"></i></a></td>
                                        <td><a href="categories.php?del=<?php echo $category_id;?>"><i class="btn btn-warning fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
